...
// //Icons
// const earningIcon = <AiFillDollarCircle size={40} color='#FFFFFF' />
// const productIcon = <BsCart4 size={40} color='#FFFFFF' />
// const categoryIcon = <BiCategory size={40} color='#FFFFFF' />
// const outOfStockIcon = <BsCartX size={40} color='#FFFFFF' />
...
//   return (
//     <div className='product-summary'>outOfStock
